...
import org.example.bigdata.realtime.flink.streaming.rdo.QRealtimeDO.OrderTrafficDimMeaData
...
class OrderStatisKSchema(topic:String) extends KafkaSerializationSchema[OrderTrafficDimMeaData] with KafkaDeserializationSchema[OrderTrafficDimMeaData] {
   ...
   * @return
   */
  override def serialize(element: OrderTrafficDimMeaData, timestamp: java.lang.Long): ProducerRecord[Array[Byte], Array[Byte]] = {

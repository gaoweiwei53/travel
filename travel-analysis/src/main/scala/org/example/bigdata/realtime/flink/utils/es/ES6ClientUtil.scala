...
import org.example.bigdata.realtime.flink.utils.es.ESConfigUtil.ESConfigSocket
...
import scala.collection.JavaConverters._
  ...
  object ES6ClientUtil {
    ...
    //es连接客户端对象返回
    def buildTransportClient(esConfigPath: String =
                             QRealTimeConstant.ES_CONFIG_PATH): PreBuiltTransportClient = {
      ...
      val transAddrs :mutable.Buffer[InetSocketAddress] =
        esConfig.transportAddresses.asScala
      //es 参数
      ...
      if (transportClient.connectedNodes.isEmpty) {
        ...
        info = "Created Elasticsearch TransportClient with connected nodes {}"+
    ...
    def main(args: Array[String]): Unit = {
      ...
      val idxName = "test";
      val esID = "000000"
      val value = new java.util.HashMap[String,String]()
      value.put("num","10001")
      value.put("age","10")
      ...
      else println(response.status().getStatus)
    }
}
